...
@code
    ...
    Dim regexTest = New Func(Of String, Boolean)(Function(i) Regex.IsMatch(i, "jquery-[0-9]+.[0-9]+.[0-9]+.js|jquery-ui-[0-9]+.[0-9]+.[0-9]+.js|knockout-[0-9]+.[0-9]+.[0-9]+.js", RegexOptions.Compiled Or RegexOptions.IgnoreCase))
